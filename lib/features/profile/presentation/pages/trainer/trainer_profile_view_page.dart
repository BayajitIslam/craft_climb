...
import 'package:craft_climb/features/profile/presentation/pages/trainer/trainer_profile_edit_page.dart';
...
class TrainerProfileViewPage extends StatelessWidget {
  static Route route() =>
      MaterialPageRoute(builder: (_) => const TrainerProfileViewPage());
  const TrainerProfileViewPage({super.key});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: AppTextStyle.s12w4i(color: Colors.grey.shade700),
                    ),
